...
- The ``ExpRandomForestClassifier`` and ``RandomForestRegressor`` derived
...
def _parallel_build_trees(
    ...
    if bootstrap:
        ...
        # TODO: Implement custom logic based on rarity scores instead here
        print("Using rarity scores to sample data for tree %d" % (tree_idx + 1))

        # TODO: Transform rarity_scores to probabilities (make sure they sum to 1)
        rarity_scores = rarity_scores / np.sum(rarity_scores)

        # TODO: Use numpy to create a random sample AND include rarity scores as probabilities
        #  This will give samples with a higher rarity score a higher chance of being selected
        ...
        # TODO: create a nicely formatted table that includes the indices, their rarity scores and how often they were sampled
        # print(
        #     "Sampled indices for tree %d:\n"
        #     "Index\tRarity Score\tSample Count\n"
        #     % (tree_idx + 1)
        # )
        # for idx in range(len(indices)):
        #     index = indices[idx]
        #     rarity_score = rarity_scores[index]
        #     sample_count = sample_counts[index]
        #     if rarity_score > 0.0004:
        #         print(f"{index}\t{rarity_score:.4f}\t{sample_count}")
...
class BaseForest(MultiOutputMixin, BaseEnsemble, metaclass=ABCMeta):
    ...
    def fit(self, X, y, sample_weight=None):
        ...
        # TODO: Calculate rarity scores based on the full X here
        rarity_scores = calculate_cb_loop(X, y)
...
class ExpRandomForestClassifier(ForestClassifier):
    """
